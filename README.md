...
* Designed and implemented a hybrid networking environment using Azure and GNS3 to securely separate government and civilian workloads through VLAN segmentation and controlled routing.

* Configured Azure Virtual Networks, Network Security Groups, DHCP services, firewall policies, and hybrid connectivity to demonstrate enterprise networking and cloud security concepts.
